...
{
    const {data} = useDataFecther('/user/bgPhoto');
    if (data && data.data[0]) {

        console.log (data.data[0].oeuvres, data.data[0].projets);
    }
    ...
    if (data && data.data[0]) {
        ...
        const oeuvreUrl = `${staticFile}/${data.data[0].oeuvres}`;
        return (
             ...
             <section className=" flex flex-col  mt-28 justify-center lg:px-20 px-5 items-center" >
                ...
                <div className="flex gap-10 justify-center w-full items-center mt-10 relative lg:px-14 px-9 pt-20 mb-5 lg:flex-row flex-col p-4">
                    ...
                    <h1 className="sm:text-3xl text-2xl text-gray-200 absolute top-4 font-bold">Oeuvres</h1>
                        ...
                        <div style={{backgroundImage: `url(${oeuvreUrl})`}} className={`  bg-center bg-no-repeat bg-[length:400px_400px] lg:bg-cover lg:w-2/5 w-full rounded-xl flex flex-col items-center justify-center h-80 duration-500 `}>
                    ...
                    <div style={{backgroundImage: `url(${staticFile}/${data.data[0].projets})`}} className={`  bg-center bg-no-repeat bg-[length:400px_400px] lg:bg-cover lg:w-2/5 w-full rounded-xl flex flex-col items-center justify-center h-80 duration-500 `}>
                        <div className="w-full h-full hover:backdrop-blur-sm duration-500 flex flex-col justify-center items-center">
                            <div className=" w-3/5 h-3/5 bg-gray-700 p-5 bg-opacity-40 flex flex-col justify-center items-center rounded-md">
           ...
           <div className="w-full">
             <section className=" flex flex-col  mt-28 justify-center lg:px-20 px-5 items-center" >
                ...
                <div className="flex gap-10 justify-center w-full items-center mt-10 relative lg:px-14 px-9 pt-20 mb-5 lg:flex-row flex-col p-4">
                    ...
                    <div style={{backgroundImage: `url(${k})`}} className={`  bg-center bg-no-repeat bg-[length:400px_400px] lg:bg-cover lg:w-2/5 w-full rounded-xl flex flex-col items-center justify-center h-80 duration-500 `}>
                        <div className="w-full h-full hover:backdrop-blur-sm duration-500 flex flex-col justify-center items-center">
                            <div className=" w-3/5 h-3/5 bg-gray-700 p-5 bg-opacity-40 flex flex-col justify-center items-center rounded-md">
                                <h3 className='sm:text-2xl text-xl font-bold text-teal-300'>Projets</h3>
                            </div>
